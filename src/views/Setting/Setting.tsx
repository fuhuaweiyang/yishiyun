    ...
    return (
        <View style={{backgroundColor:theme.backgroundColor }}>
            ...
            <ScrollView
                ...
                <TouchableOpacity onPress={loginOut} style={{backgroundColor:theme.backgroundColor}}>
                    <Text style={[styles.buttonText,{backgroundColor:theme.itemBackgroundColor}]}>退出登录</Text>
                </TouchableOpacity>
            </ScrollView>
        </View>
    )
